...
inline void brk(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode) {
    cpu->is_stopped = true;
}

inline void ora(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){
    unsigned char* addr = get_address(nes, cpu, mode);
    cpu->acc |= *addr;
}

inline void kil(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){
    cpu->is_stopped = true;
}

inline void slo(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void asl(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void php(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void aac(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void bpl(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void clc(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void jsr(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void and(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void rla(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void bit(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void rol(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void plp(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void bmi(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sec(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void rti(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void eor(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sre(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void lsr(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void pha(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void asr(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void jmp(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void bvc(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void cli(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void rts(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void adc(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void rra(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void ror(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void pla(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void arr(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void bvs(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sei(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sta(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sax(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sty(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void stx(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void dey(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void txa(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void xaa(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void bcc(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void axa(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void tya(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void txs(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void xas(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sya(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sxa(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void ldy(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void lda(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void ldx(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void lax(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void tay(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void tax(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void atx(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void bcs(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void clv(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void tsx(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void lar(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void cpy(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void cmp(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void dcp(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void dec(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void iny(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void dex(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void axs(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void bne(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void cld(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void cpx(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sbc(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void isb(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void inc(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void inx(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void nop(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void beq(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){

}

inline void sed(struct Nes* nes, struct CPU* cpu, enum AddressingMode mode){
